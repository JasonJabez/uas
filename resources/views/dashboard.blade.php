 ...
 @section('content')
         ...
         <div class="container">
             ...
             <div class="row g-4">
                 @foreach ($hotels as $hotel)
                     <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s" style="height: 600px;">
                         <div
                             class="room-item shadow rounded overflow-hidden h-100 d-flex flex-column justify-content-between">
                             <div class="position-relative">
                                 <img class="img-fluid w-100" style="height: 200px; object-fit: cover;"
                                     src="{{ $hotel->image_url }}" alt="">
                                 <small
                                     class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4">{{ $hotel->type }}</small>
                             </div>
                             <div class="p-4 mt-2 d-flex flex-column justify-content-between">
                                 <div>
                                     ...
                                     <div class="d-flex mb-3">
                                         <small class="border-end me-3 pe-3">{{ $hotel->type }}</small>
                                         <small class="border-end me-3 pe-3"><i class="fa fa-bath text-primary me-2"></i>2
                                             Bath</small>
                                         <small><i class="fa fa-wifi text-primary me-2"></i>Wifi</small>
                                     </div>
                                     <p class="text-body mb-3">{{ $hotel->phone }}</p>
                                     <p class="text-body mb-3">{{ $hotel->email }}</p>
     ...
     <div class="container-xxl py-5">
         <div class="container">
             <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                 <h6 class="section-title text-center text-primary text-uppercase">Our Facilites</h6>
                 <h1 class="mb-5">Explore Our <span class="text-primary text-uppercase">Faciities</span></h1>
             </div>
             <div class="row g-4">
